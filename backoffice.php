...
<div class="container">
  <div class="backofficebtn">
    <button class="backbuttonform btn btn-primary" id="add">Ajouter un service</button>
    <button class="backbuttonform btn btn-primary" id="update">Modifier un service</button>
  </div>
          ...
          <div class="col">
            <div class="card h-100 card-services">
              ...
              <div class="card-footer" id="card-footer">
                <button type="submit" class="card-update backbuttonform btn btn-primary" id="card-update">Edit</button>
              </div>
            </div>
          </div>
          <?php
